...
- <i class="far fa-exclamation"></i> [Understanding the web](/pages/web/understanding-the-web)
- <i class="far fa-exclamation"></i> [Introduction to HTML](/tutorials/introduction-to-html)
- <i class="far fa-exclamation"></i> [Pip and VirtualEnv](/pages/python/pip-and-virtualenv)
- <i class="far fa-exclamation"></i> [A web-framework for Python: Flask](/pages/python/python-flask)
...
- [Tips & Tricks](/pages/web/web-with-python-tips.md)
- [About unique identifiers](/pages/general/unique-id.md)
